...
class WPOLearner(acme.Learner):
  ...
  def __init__(  # pytype: disable=annotation-type-mismatch  # numpy-scalars
      ...
      dual_optimizer: Union[optax.GradientTransformation, None] = None,
      ...
      counter: Union[counting.Counter, None] = None,
      logger: Union[loggers.Logger, None] = None,
      devices: Union[Sequence[Any], None] = None,
  ):
  ...
  def _sgd_step(
    ...
    metrics.update(jax.tree_util.tree_map(jnp.mean, dual_metrics))
  ...
  def save(self) -> TrainingState:
    return jax.tree_util.tree_map(wpo_utils.get_from_first_device, self._state)
