...
class WPONetworkParams(NamedTuple):
  policy_head: Union[hk.Params, None] = None
  critic_head: Union[hk.Params, None] = None
  torso: Union[hk.Params, None] = None
  torso_initial_state: Union[hk.Params, None] = None
...
class UnrollableNetwork:
  ...
  unroll: Callable[[hk.Params, types.Observation, hk.LSTMState],
                   tuple[jnp.ndarray, hk.LSTMState]]
  initial_state_fn_init: Callable[[networks_lib.PRNGKey, Union[int, None]],
                                  hk.Params]
  initial_state_fn: Callable[[hk.Params, Union[int, None]], hk.LSTMState]


@dataclasses.dataclass
class WPONetworks:
  """Network for the WPO agent."""
  policy_head: Union[hk.Transformed, None] = None
  critic_head: Union[hk.Transformed, None] = None
  torso: Union[UnrollableNetwork, None] = None
  dynamics_model: Union[UnrollableNetwork, None] = None
...
def make_unrollable_network(
    ...
    make_feedforward_module: Union[Callable[[], hk.SupportsCall], None] = None,
    make_initial_state_fn: Union[Callable[[], hk.SupportsCall], None] = None,
) -> UnrollableNetwork:
  """Produces an UnrollableNetwork and a state initializing hk.Transformed."""

  def default_initial_state_fn(batch_size: Union[int, None] = None) -> jnp.ndarray:
...
def add_batch(nest, batch_size: Union[int, None]):
...
class IdentityRNN(hk.RNNCore):
  ...
  def initial_state(self, batch_size: Union[int, None]):
...
class GRU(hk.GRU):
  ...
  def __init__(self, hidden_size: int, name: Union[str, None] = None):
