...
class ModelOutputs:
  ...
  policy: Union[types.NestedArray, None] = None
  q_value: Union[types.NestedArray, None] = None
  value: Union[types.NestedArray, None] = None
  reward: Union[types.NestedArray, None] = None
  embedding: Union[types.NestedArray, None] = None
  recurrent_state: Union[types.NestedArray, None] = None
  actions: Union[types.NestedArray, None] = None
  q_values_grad: Union[types.NestedArray, None] = None
...
class LossTargets:
  ...
  # Policy targets.
  policy: Union[types.NestedArray, None] = None
  a_improvement: Union[types.NestedArray, None] = None
  q_improvement: Union[types.NestedArray, None] = None
